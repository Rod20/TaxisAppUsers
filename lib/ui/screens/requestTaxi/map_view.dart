...
class _MapViewState extends State<MapView> {
  ...
  String _APIKEY = "AIzaSyBv_6FBDgGL7X8lOYaiQvnZEM6brjiYRZw";
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _textField(
                              label: 'Mi ubicación',
                              hint: 'Escoge un punto de comienzo',
                              ...
                              _calculateDistance().then((isCalculated) {
                                if (isCalculated) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Distancia Calculada Satisfactoriamente'),
                                    ),
                                  );
                                } else {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Error En El Cálculo De La Distancia'),
                                    ),
                                  );
                                }
                              });
